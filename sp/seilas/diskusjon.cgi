...
# 8. oktober 1995, sist endret 24. januar 1996

# Konfigurering gjøres kun i de neste 7 linjene samt i subrutinene
# 'header' og 'footer'

$TOPPDIR	= "/local/www/sp/seilas";	# top directory
$TOPP		= "/sp/seilas";		# top URL
...
$NOTIFYRCPT	= 'kgn@a.sn.no,arneom@a.sn.no';
...
<a href="/seilas/">
<img alt="[Seilas' hjemmeside]" src="/seilas/logo3.gif"
...
<center>
  <font size="-1">
  Diskusjonsgruppen er laget for <a href="/seilas/">Seilas</a>
