...
# $PATH	    = $ENV{'PWD'};
$BASE       = "/local/www/snroot/";     # Webens root
$LOCATION   = "/local/www/snroot/gen";  # Her legges de genererte sidene for Netscape
$M_LOCATION = "/local/www/snroot/genm"; # Her legges de generete sidene for Mosaic
$URL_BASE   = "/gen";  # URL-base for Netscape 
$M_URL_BASE = "/genm"; # URL-base for Mosaic
