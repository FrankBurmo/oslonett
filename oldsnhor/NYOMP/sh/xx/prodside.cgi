...
open(PROD_FIL, "<$kat_file") || die "can't open input file $PRODFILE\n";
...
while (<PROD>)
	...
	if (/^$indeksnr/) {
	    $funnet=1;
	    ($nr,$navn,$pris,$tekst,$bilde)=split(/\#/o);
...
Varenr: $nr<p>
$tekst <p>
<a href=\"$KURV_HENT/$BUTIKK_ID/$nr?ref=$ENV{SCRIPT_NAME}%3F$nr\"><img src=\"$gifimg\" border=\"0\" alt=\"\"><p>$kurvetxt<\/a>
<p>
...
";
	    ...
	    if ($bilde ne "") {
		print "<td><img src=\"/sh/is/katalog/images/$bilde\" border=\"0\" alt=\"\"></td>";
	    }
