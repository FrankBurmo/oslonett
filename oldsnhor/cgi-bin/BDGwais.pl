...
$openingTitle = "Search Big Dummys Guide To The Internet:";

# after searching, what to you want the title to be?
$closingTitle = "Search Big Dummys Guide To The Internet:";
...
sub send_index {
    ...
    print "<BODY>\n<H2>", $openingTitle, "</H2>\n";
    print "<img src=/graphics/lamp.gif>\n";

    print "<p>";
    print "This is an index of  the Big Dummys Guide To The Internet. ";
    ...
    print "<DD>The query 'inter\\*' will find documents containing the words";
    print " 'internet' as well as 'internauts'.<P>";
    ...
    print "<a href=/html/bdgtti/index.html><img alt=[BDGTTI] src=/html/bdgtti/logos/bdgtti-icon.gif></a>";
}
...
#    local($top, $path, $query, $src, $title) = @_;
    ...
    print "<BODY>\n<p><img alt=\"[Search Icon]\" src=/graphics/lamp.gif>\n<H2>", $closingTitle, "</H2>\n";
