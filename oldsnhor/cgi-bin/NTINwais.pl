...
$openingTitle = "Search information from Norwegian Travel Information Network at Oslonett Inc:";

# after searching, what to you want the title to be?
$closingTitle = "Search information from Norwegian Travel Information Network at Oslonett Inc:";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of information within NTIN on THIS WWW server. ";
    ...
    print "<a href=/NTIN/NTIN.html><img alt=[NTIN] src=/NTIN/gifs/NTIN-icon.gif></a>";
}
