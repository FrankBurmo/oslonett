...
sub send_index {
    ...
    print "<BODY background=http://www.oslonett.no/gifs/on/onbg.gif>\n";
    print "<img alt=Oslonett AS src=http://www.oslonett.no/gifs/on/oslonett-press.gif>\n";
    print "<H2>", $openingTitle, "</H2>\n<ISINDEX>";
    print "<img alt=\"\" src=/graphics/binoc-t.gif>\n";

    print "<p>";

    print "This is an index of press releases from Oslonett published automatically";
    print "in our web server.<p>";
    ...
    print "<a href=http://www.oslonett.no/on/presse/>Press Releases from Oslonett</a>";
}
