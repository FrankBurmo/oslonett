...
$openingTitle = "Let i Web sidene for Nettverksexpo'94";

# after searching, what to you want the title to be?
$closingTitle = "Let i Web sidene for Nettverksexpo'94";
...
sub send_index {
    ...
    print "<BODY>\n<H2>", $openingTitle, "</H2>\n";
    print "<img alt=\"\" src=/EXPO94/gifs/binoc.gif>\n";

    print "<p>";
    print "This is an index of information within Nettverksexpo'94 on this WWW server. ";
    ...
    print "<a href=/EXPO94/index.html><img alt=\"[Nettverksexpo]\" src=/EXPO94/gifs/expo-icon.gif></a>";
}
...
#    local($top, $path, $query, $src, $title) = @_;
    ...
    print "<BODY>\n<p><img alt=\"\" src=/EXPO94/gifs/binoc.gif>\n<H2>", $closingTitle, "</H2>\n";
