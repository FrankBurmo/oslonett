...
$mottager = "baard.storsveen@kelly.no";


open(MAIL, "|$mailprog $mottager") || die "Greide ikke å åpne mail-programmet!\n";
print MAIL "Dette er en mail som er blitt sendt automatisk fra KELLYs jobbsøkingsprogram i WWW. Nedenfor finner du avsenders kompetanse sammen med kontaktinformasjon: \n\n";
...
print  "<H1> Takk </H1>\n";
print  "Du har nå sendt en jobbsøknad til KELLY. Følgende informasjon er blitt sendt: <p>";
...
print  " Utdannelse: $FORM{'utdannelse'} \n";
print  "   Erfaring: $FORM{'erfaring'} \n\n";
print  "   </pre><p>";
...
sub blank_response
{
    ...
    print "<A HREF=\"http://www.kelly.no/kelly/cv.html\">Prøv en gang til</A>, eller ";
