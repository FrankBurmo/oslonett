...
$openingTitle = "Search information from The Climbing Index for Europe at Oslonett Inc:";

# after searching, what to you want the title to be?
$closingTitle = "Search information from The Climbing Index for Europe at Oslonett Inc:";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of information within the Climbing Index on THIS WWW server. ";
    ...
    print "<a href=/sp/fjell/climbing/><img alt=[Index] src=/sp/fjell/climbing/europe_btn.gif></a>";
}
