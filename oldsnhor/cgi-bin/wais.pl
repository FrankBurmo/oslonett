...
$openingTitle = "Search Oslonett's central Web pages:";

# after searching, what to you want the title to be?
$closingTitle = "Search Oslonett's central Web pages:";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of a portion of Oslonett's Web hierarchy. ";
    ...
    print "<a href=/index.html><img alt=[Home] src=/graphics/home.gif></a>";
}
