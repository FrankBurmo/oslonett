...
sub send_index {
    ...
    print "<img alt=SN Horisont src=http://www.sn.no/img/snlogo.gif>\n";
    print "<H2>", $openingTitle, "</H2>\n<ISINDEX>";
    print "<img alt=\"\" src=/graphics/binoc-t.gif>\n";

    print "<p>";

    print "This is an index of news releases from SN Horisont published automatically";
    ...
    print "<a href=/><img src=/img/horisont.gif></a>\n";
...
#    local($top, $path, $query, $src, $title) = @_;
    ...
    print "<BODY bgcolor=\"#ffffff\">\n";
    print "<img alt=\"\" src=http://www.sn.no/img/snlogo.gif>\n";
