...
$filnavn = "/public/www/TMP/KRopptavle.html";
$tmpfil1 = "/public/www/TMP/tmpfil1.$$";
...
print "Takk for at du ville legge inn denne beskjeden i <I>oppslagstavla til Kommunal Rapport.</I>!<P>";
...
sub blank_response
{
    ...
    print "på Kommunal Rapports elektroniske oppslagstavle. ";
    exit;
}
...
{
    open (TAVLE,">$filnavn");
    print TAVLE "<TITLE>Kommunal Rapport's elektroniske oppslagstavle</TITLE>\n";
    print TAVLE "<H1>Kommunal Rapport's elektroniske oppslagstavle</H1>\n";
    print TAVLE "<hr>\n";
    print TAVLE "<!--her-->\n";
    close (TAVLE);
    open (FIL1,"<$filnavn")
