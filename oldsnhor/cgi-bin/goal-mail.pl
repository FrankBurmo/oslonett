...
print MAIL "Dette er informasjon som er blitt sendt automatisk ved hjelp av GOALs elektroniske abonnementsbestilling: \n\n";
...
print  "<H1> Takk </H1>\n";
print  "Du har nå bestilt et abonnement på fotballbladet GOAL, og vi har registrert følgende informasjon: <p>";
print  " <pre>       Navn: $FORM{'Navn'} \n";
print  "    Adresse: $FORM{'Adresse'} \n";
print  "     Postnr: $FORM{'Pnr'} $FORM{'Poststed'} \n";
...
<hr><center><a href=\"/me/ts/goal/\"><img alt=\"\" src=\"/me/ts/goal/gifs/goal_200.gif\" width=150 border=0></a></center><hr>\n\n";
    ...
    print "<A HREF=\"http://www.oslonett.no/me/ts/goal/bestilling.html\">Prøv en gang til</A>, eller ";
