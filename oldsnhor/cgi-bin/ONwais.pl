...
$openingTitle = "Search Oslonett's company info:";

# after searching, what to you want the title to be?
$closingTitle = "Search Oslonett's company info:";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of Oslonett's central Web pages describing the company. ";
