...
$openingTitle = "Search results and information from Soccer WC'94";

# after searching, what to you want the title to be?
$closingTitle = "Search results and information from Soccer WC'94";
...
sub send_index {
    ...
    print "<a href=/wc94/index.html><img alt=[WC94] src=/graphics/wc94-no.gif></a>";
}
