...
$openingTitle = "Let i informasjonsbasen til NæringsEiendom A/S i WWW på Oslonett:";

# after searching, what to you want the title to be?
$closingTitle = "Let i informasjonsbasen til NæringsEiendom A/S i WWW på Oslonett:";
...
sub send_index {
    ...
    print "<p>";
    print "Dette er en søkbar indeks over informasjon fra NæringsEiendom A/S, lagret i Oslonetts Web server. ";
    ...
    print "<DD>Søket 'dyr\\*' vil finne dokumenter som inneholder ordene";
    print " 'dyr' så vel som 'dyrehage'.<P>";
    print "<DT>Logiske '<b>And</b>' uttrykk";
    print "<DD>Søket 'sentralt AND billig' vil finne det logiske <B>snittet</b> av alle";
    print " dokumentene som inneholder ordene 'sentralt' og 'billig'. ";
    print "Bruken av ordet 'and' begrenser dermed søket.<p>";
    print "<DT>Logiske '<b>Or</b>' uttrykk";
    print "<DD>Søket 'sentralt or fasjonabelt' vil finne den logiske <B>unionen</b> av alle";
    print " dokumentene som inneholder ordene 'sentralt' eller 'fasjonabelt'. ";
    print "Bruken av ordet 'or' øker dermed søket.<p>";
    print "<DT>Logiske '<b>Not</b>' uttrykk";
    print "<DD>Søket 'sentralt not Oslo' vil finne alle dokumentene som inneholder";
    print " ordet 'sentralt', men <b>ekskluderer</b> de av disse som inneholder ordet 'Oslo'.";
    print "Bruken av ordet 'not' begrenser dermed søket.<p>";
    print "<DT><b>Nestede</b> logiske uttrykk";
    print "<DD>Søket '\\(sentralt AND billig\\) OR Oslo NOT vest' vil finne unionen av alle";
    print " dokumentene som inneholder ordene 'sentralt' OG 'billig'. Så vil dokumenter inneholdende ordet 'Oslo' bli addert (union), og ";
    print " til slutt vil alle dokumentene inneholdende ordet 'vest' bli ekskludert.";
    print "</DL>";
    ...
    print "<a href=http://www.oslonett.no/me/ts/ne/index.html><img alt=\"[ NæringsEiendom ]\" src=http://www.oslonett.no/me/ts/ne/gifs/ne-small.gif></a>";
}
