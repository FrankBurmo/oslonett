...
$openingTitle = "Let i IDGs Web sider";

# after searching, what to you want the title to be?
$closingTitle = "Let i IDGs Web sider";
...
$toSubtract = "http://www2.oslonett.no";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of information within IDG's Web pages on this WWW server. ";
    ...
    print "<a href=http://www2.oslonett.no/me/bh/idg/index.html><img alt=[IDG] src=http://www2.oslonett.no/me/bh/idg/IDG.gif></a>";
}
