...
$openingTitle = "Search EFF's Extended Guide To The Internet:";

# after searching, what to you want the title to be?
$closingTitle = "Search EFF's Extended Guide To The Internet:";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of  the EFF's Extended Guide To The Internet. ";
    ...
    print "<a href=/html/eegtti/index.html><img alt=\"[EEGTTI]\" src=/html/eegtti/logos/eegtti.gif></a>";
}
...
#    local($top, $path, $query, $src, $title) = @_;
    ...
    print "<BODY>\n<p><img alt=\"\" src=/graphics/lamp.gif>\n<H2>", $closingTitle, "</H2>\n";
