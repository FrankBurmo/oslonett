...
$openingTitle = "Search NTB wire messages  from The 1994 Winter Olympics at Lillehammer";

# after searching, what to you want the title to be?
$closingTitle = "Search NTB wire messages from The 1994 Winter Olympics at Lillehammer:";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of the NTB wire messages from The 1994 Winter Olympics at Lillehammer. ";
