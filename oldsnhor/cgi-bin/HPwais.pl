...
sub send_index {
    ...
    print "<p>";
    print "This is an index of Hewlett-Packard's Web pages on this WWW server. ";
    ...
    print "<a href=http://www.oslonett.no/home/hpnorge/><img alt=[HP] src=http://www.oslonett.no/home/hpnorge/hp.gif></a>";
}
