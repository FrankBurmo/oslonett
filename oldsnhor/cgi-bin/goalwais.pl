...
$modified = "20.november 1995 [Arne Petter Omholt, Schibsted Nett AS]";
...
sub send_index {
    ...
    print "<hr><center><a href=\"/me/ts/goal/\"><img alt=\"\" src=\"/me/ts/goal/gifs/goal_200.gif\" width=150 border=0></a>\n\n";
    print "<isindex prompt=\"Søk i GOALs artikler\" </center>";
    print "<H2> $openingTitle </H2>\n";

    print "<p>";
    print "Dette er en søkbar indeks over alle GOALs artikler. ";
    ...
    print "<a href=/me/ts/goal/>GOAL</a>";
}
...
#    local($top, $path, $query, $src, $title) = @_;
    ...
    print "<BODY bgcolor=#503060 text=#ffffff link=#ffffaa vlink=#ffffaa>\n";
    print "<hr><center><a href=\"/me/ts/goal/\"><img alt=\"\" src=\"/me/ts/goal/gifs/goal_200.gif\" width=150 border=0></a></center>\n\n";
    print "<isindex prompt=\"Søk i GOALs artikler\" </center>";
    print "<H2> $closingTitle </H2>\n";

    print "<b>Resultat av søk på \`$pquery\':<P></b>\n";
    print "<DL>\n";
    ...
    print "<a href=/html/adv/PS/PS.html><img src=/html/adv/PS/polysoft1.gif></a>";
    if ($hits == 0) {
        print "Nothing found.\n";
    }
    print "</BODY>\n";
