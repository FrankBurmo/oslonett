...
$openingTitle = "Let i ComputerWorlds WWW utgaver";

# after searching, what to you want the title to be?
$closingTitle = "Let i ComputerWorlds WWW utgaver";
...
sub send_index {
    ...
    print "<a href=/CW/CW.html><img alt=\"[CW]\" src=/CW/gifs/cw.gif></a>";
}
