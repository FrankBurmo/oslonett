...
$openingTitle = "Search The Oslonett Marketplace electronic mall:";

# after searching, what to you want the title to be?
$closingTitle = "Search The Oslonett Marketplace electronic mall:";
...
sub send_index {
    ...
    print "<p>";
    print "This is an index of The Oslonett Marketplace - Norway's premium Internet mall. ";
    ...
    print "<a href=/html/adv/ON-market.html><img alt=[OMP] src=graphics/market.gif></a>";
}
