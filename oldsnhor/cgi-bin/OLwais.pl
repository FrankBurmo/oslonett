...
$waisd = "/public/wais/OL";

# what database do you want to search?
$src = "Olympics";

# what is the opening title you want to present to users
$openingTitle = "Search results from The 1994 Winter Olympics at Lillehammer";

# after searching, what to you want the title to be?
$closingTitle = "Search results from The 1994 Winter Olympics at Lillehammer:";
...
$toSubtract = "http://ol.oslonett.no/OL";
...
sub extractTitle {
  ...
  $linenum = 1;
  $foundtitle = 0;
#  $humanTitle = "(No title found in document - probably an image!)";
...
sub send_index {
    ...
    print "<BODY>\n<H2>", $openingTitle, "</H2>\n";
    print "<img src=/graphics/Ringene-small.gif>\n";
    ...
    print "<HR>";
    print "This server is maintained by $maintainer, and it was last modified on $modified.<p>";
}
...
#    local($top, $path, $query, $src, $title) = @_;
    ...
    print "<BODY>\n<img src=/graphics/Ringene-small.gif>\n<H2>", $closingTitle, "</H2>\n";
