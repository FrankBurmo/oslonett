...
$TOPPDIR	= "/home/steinar/frogner/newsdesk";	# top directory
$TOPP		= "/newsdesk";		# top URL
...
$NOTIFYRCPT	= 'kgn@intelli.no,steinar@manamind.com';
...
EOT
    ...
    print MAIL "------------------------------------------------------------\n";
    print MAIL "Denne meldingen er automatisk generert av et gammelt Perl skript fra SN Horisont!\n";
    print MAIL "\n.\n";
    close MAIL;
    exit 0;
}
