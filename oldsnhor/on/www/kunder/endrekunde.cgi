...
# utfylt, returnerer feilmelding og avslutter hvis >= 1 felt mangler.
	...
	&printheader("Oppdatering av kundedata: for få felter utfylt");
	print <<EOT;
