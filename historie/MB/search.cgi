...
# Ønsker vi å hoppe over spesielle filer, angis de i dette regexpet
   ...
   my $skiplist = 'index\.htm?l|current\.html';



# 3:
# Start for rekursjonen
 my $top     = "/home/oslonett/www/historie/MB/utg";
 my $root = "$top/..";
...
sub show_results {
    ...
    print "Location: http://www.oslo.net/historie/MB/search.cgi$query{path}\n\n";
    exit;
