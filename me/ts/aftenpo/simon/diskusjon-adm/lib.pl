...
$TOPPDIR	= "/local/www/me/ts/aft/simon";
$TOPP		= "/simon";
$NOTIFYRCPT	= 'steinar@a.sn.no,kgn@a.sn.no';
# Mottaker av beskjeder om nye innlegg.
...
<p><hr noshade>
<center>
Tilbake til <a href="http://www.aftenposten.no/">Aftenpostens toppside</a>
</center>
</body>
</html>
EOT
