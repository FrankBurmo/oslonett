...
# Program for diskusjonsgrupper i VGs web-sider. Programmet brukes for
# å hente ut og å sende inn innlegg i vilkårlig gruppe. Aktuell gruppe
# velges fra environment-variablen PATH_INFO, er det ikke angitt brukes
# $DEAFULT. Ved innsending av nytt oppslag leses CGI-input som er sendt
# med med metode POST eller GET.
#
# Kaare Gunnar Nesheim, <kgn@oslonett.no>
# 8. oktober 1995, sist endret 8. oktober 1995

$TOPPDIR	= "/local/www/me/ts/goal";
$TOPP		= "/me/ts/goal";
$DISKUSJONDIR	= "$TOPPDIR/diskusjon-adm";
$TELLERFIL	= "$DISKUSJONDIR/teller.txt";
$MININDENT	= "      ";
$NOTIFYRCPT	= 'arneom@oslonett.no,serief@oslonett.no';
...
<hr>
  <a href="$TOPP/">
      <img alt="" src="$TOPP/gifs/goal_200.gif" width="150"
...
<p><hr>
<center>
<a href="$TOPP/">Tilbake til GOALs hjemmeside</a>
</center>
</body>
</html>
EOT
