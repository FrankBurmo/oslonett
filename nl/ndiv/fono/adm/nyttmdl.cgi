...
# Returnerer HTML-kode med tilbakemelding om at alt gikk bra
    ...
    &printheader("Medlemsregistrering: tilbakemelding");

    print "Vi har registrert følgende informasjon om dette medlemmet:\n";
...
<input type="submit" name="Knapp" value="Slett dette medlemmet">
</form>
