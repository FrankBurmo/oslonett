...
while (<RESULTAT>) {
    ...
    # Må fylle inn kolonnen med plassering dersom denne mangler fordi man ved søk 
    # kun viser treff-linjene (og da må kolonne 0 vise riktig plassering).
