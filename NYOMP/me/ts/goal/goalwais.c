...
** Achim Jung, Alexander Gagin, Jim Robb, Steinar Kjaernsrod and many
** others for good suggestions and patches.
*/

/* You will need to define the following option! */

#define CONFFILE "/home/frogner/www/wais/lib/goalwais.conf"
...
#define VERSION "2.5"
#define WAISTITLE "Søk i samtlige artikler"
#define GIFURL "/me/ts/goal/gifs/goal_200.gif"
...
printheader()
{
	...
	if (lstrstr(pagetitle, ".html")) {
		if ((fp = fopen(pagetitle, "r")) != NULL) {
			...
			printf("<body bgcolor=\"#503060\" text=#ffffff link=#ffffaa vlink=#ffffaa>\n");
			printf("<hr><center><a href=\"/me/ts/goal/\"><img alt=\"\" src=\"%s\"width=150 border=0></a></center><hr></center>\n", GIFURL);
...
printversion()
{
	...
	printf("<hr><center><a href=\"/me/ts/goal/\"><img alt=\"\" src=\"%s\"width=150 border=0></a></center><hr></center>\n", GIFURL);
	printf("<h1>%s</h1>\n", VERSTITLE);
	printf("This is WWWWAIS version %s, patched for GOAL at Schibsted Nett.\n<br>\n", VERSION);
}
...
printform()
{
	...
	printf("Dette er et søkegrensesnitt mot GOALs online utgaver, som er lagt ut i Schibsted Netts World Wide Web server.<p>\n");
	printf("<b>NB!</b> <i>Din Web klient må ha støtte for HTML skjemaer (forms) for å bruke dette.</i><p></n>");


	printf("Gi et søkeuttrykk : ");
	printf("<input type=\"text\" name=\"keywords\" value=\"%s\" size=50> ",
	keywords);
	printf("<p>\n<input type=\"submit\" value=\"  Let  \"> ");
	printf("<input type=\"reset\" value=\"  Resett  \">\n<p>\n");
	...
	if (no_options)
		...
		NO_SELECT);
        printf("</form><hr><i>© Schibsted Nett AS og GOAL.</i><hr>\n");
}
