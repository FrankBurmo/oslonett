...
$kat_file=join("",$index_root,"katalog/ab.txt");
$prod_file=join("",$index_root,"katalog/pb.txt");
$header_dir="header/";
$footer_dir="footer/";
...
foreach $_ (@UNDERKAT) {
    ...
    if ($par eq $ukat) {
	$U_LINJE[$count++] = join("", "<img src=$URL_PATH/gifs/ar.gif><a href=\"", $this_program_name, "\?$firstkat", "\"><b><i>$TMP[1]", "</b></i></a><img src=$URL_PATH/gifs/al.gif>  ");
	$uk_navn=$TMP[1];
    } else {
...
<a href=\"$URL_PATH/index.html\"><img src=\"$URL_PATH/gifs/rsi.gif\" border=\"0\" alt=\"InterShop\"><br>[til forsiden]</a>
</td>
